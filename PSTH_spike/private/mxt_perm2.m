...
function [pval, t_orig, tmx_ptile, seed_state, est_alpha]=mxt_perm2(dataA,dataB,n_perm,alph,tail,verblevel,seed_state,freq_domain,pairTag)
...
for perm=1:n_perm
    ...
    if pairTag == 0
        ...
        r1=randperm(n_subsA,round(n_subsA/2));
        nr1 = r1 + n_subsA;
        r2 = setdiff((n_subsA + 1):total_subs,nr1);
        grp1=[r1 r2];        
        grp2=setdiff(1:total_subs,grp1);
    end
